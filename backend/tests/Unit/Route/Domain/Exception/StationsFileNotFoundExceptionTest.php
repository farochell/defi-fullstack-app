...
class StationsFileNotFoundExceptionTest extends TestCase
{
    ...
    {
        $exception = new StationsFileNotFoundException($this->testPath);

        $this->assertInstanceOf(StationsFileNotFoundException::class, $exception);
    }
    ...
    public function testExceptionHasCorrectMessage(): void
    {
        ...
        $this->assertSame(
            'Fichier stations.json introuvable.',
    ...
    public function testGetErrorCodeReturnsCorrectEnum(): void
    {
        ...
        $this->assertSame(
            ErrorCode::STATIONS_FILE_NOT_FOUND,
