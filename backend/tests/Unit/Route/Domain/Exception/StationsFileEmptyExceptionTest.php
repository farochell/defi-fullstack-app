...
class StationsFileEmptyExceptionTest extends TestCase
{
    ...
    {
        $exception = new StationsFileEmptyException($this->testPath);

        $this->assertInstanceOf(StationsFileEmptyException::class, $exception);
    }
    ...
    public function testExceptionHasCorrectMessage(): void
    {
        ...
        $this->assertSame(
            'Le fichier stations.json est vide.',
    ...
    public function testExceptionCanBeThrown(): void
    {
        ...
        $this->expectExceptionMessage('Le fichier stations.json est vide.');
        $this->expectExceptionCode(500);

        throw new StationsFileEmptyException($this->testPath);
    }
